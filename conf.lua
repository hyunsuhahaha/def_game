local function isAutomatedRun()
    for _, name in ipairs({
        ...
        "LAST_HAUL_CAPTURE_UNITS", "LAST_HAUL_CAPTURE_TEST_OPTIONS", "LAST_HAUL_CAPTURE_TURRET_PROMPT", "LAST_HAUL_CAPTURE_TURRET_PLACEMENT", "LAST_HAUL_CAPTURE_TURRET_UPGRADE"
    }) do
