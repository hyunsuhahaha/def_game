...
현재 카메라/난이도: 크레인은 흡연자 기본 줌의 0.85배인 추적 시점이며 Ctrl+휠은 0.90~1.10배로 제한한다. 전체 맵을 맞추는 자동 축소는 제거했다. 11단계 이상 재생 속도는 기존의 45%, 허용량은 +80그루(중복 가산 없음), 과밀 유예는 기존 연구 효과에 8초를 더한다.
