...
local nodes = {
    {id = "quick_work", branch = 1, tier = 1, name = "숙련된 손", max = 5, costs = {6, 9, 13, 18, 24}, desc = "모든 채집 속도 +6%", effect = "gather"},
    {id = "cargo_rig", branch = 1, tier = 2, name = "확장형 운반대", max = 4, costs = {9, 14, 20, 27}, desc = "가방 용량 +3", effect = "capacity", requires = {"quick_work", 2}},
    {id = "seed_vault", branch = 1, tier = 3, name = "보존 종자고", max = 3, costs = {13, 20, 29}, desc = "시작 씨앗 +2", effect = "seeds", requires = {"cargo_rig", 2}},
    {id = "field_route", branch = 1, tier = 4, name = "현장 동선", max = 1, costs = {35}, desc = "이동 속도 +10%", effect = "move", requires = {"seed_vault", 3}},

    {id = "wall_base", branch = 2, tier = 1, name = "강화 기초", max = 5, costs = {6, 9, 13, 18, 24}, desc = "방어벽 최대 체력 +5%", effect = "wallHp"},
    {id = "repair_drill", branch = 2, tier = 2, name = "긴급 수리 훈련", max = 4, costs = {9, 14, 20, 27}, desc = "망치 수리량 +8", effect = "repair", requires = {"wall_base", 2}},
    {id = "material_cache", branch = 2, tier = 3, name = "자재 비축고", max = 3, costs = {13, 20, 29}, desc = "시작 목재·돌 +2", effect = "materials", requires = {"repair_drill", 2}},
    {id = "last_wall", branch = 2, tier = 4, name = "최후의 방벽", max = 1, costs = {35}, desc = "방어벽 받는 피해 -10%", effect = "wallGuard", requires = {"material_cache", 3}},

    {id = "turret_trim", branch = 3, tier = 1, name = "포탑 영점 조정", max = 5, costs = {6, 9, 13, 18, 24}, desc = "자동 포탑 피해 +4%", effect = "damage"},
    {id = "cooling_loop", branch = 3, tier = 2, name = "순환 냉각", max = 4, costs = {9, 14, 20, 27}, desc = "자동 포탑 공속 +3%", effect = "fireRate", requires = {"turret_trim", 2}},
    {id = "ore_reserve", branch = 3, tier = 3, name = "정제 광석 비축", max = 3, costs = {13, 20, 29}, desc = "시작 광석 +2", effect = "ore", requires = {"cooling_loop", 2}},
    {id = "salvage_code", branch = 3, tier = 4, name = "회수 규약", max = 1, costs = {35}, desc = "유산 부품 획득 +15%", effect = "reward", requires = {"ore_reserve", 3}}
}
