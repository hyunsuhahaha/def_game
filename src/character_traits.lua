...
local scoreFireNodes={
    ...
    {id="fire_score_popper_extra",name="뻥튀기 기계 추가 설치",short="기계 +1",desc="동시에 유지되는 뻥튀기 기계가 1대 증가합니다.",effect="scorePopperExtra",value=1,max=1,costs={520},wx=1000,wy=5400,icon="capstone",color={1,.68,.24},requires={{"fire_score_popper_bounce_2",1},{"fire_score_popper_damage_3",2},{"fire_score_popper_heat_2",2}},capstone=true},
}
