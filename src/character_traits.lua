...
local scoreFireNodes={
    ...
    {id="fire_score_flame_range",name="화염 분사 거리 상승",short="분사 거리 +50",desc="화염이 닿는 거리 +50 (기본 250)",effect="scoreFlameRange",value=50,max=1,costs={26},wx=1000,wy=3350,icon="wind",color={.94,.66,.28},requires={{"fire_score_flame_unlock",1}}},
    ...
    {id="fire_score_flame_range_2",name="화염 분사 거리 상승",short="분사 거리 +50",desc="화염이 닿는 거리 +50",effect="scoreFlameRange",value=50,max=1,costs={46},wx=1150,wy=3600,icon="wind",color={.94,.66,.28},requires={{"fire_score_flame_range",1}}},
    ...
    {id="fire_score_flame_range_3",name="화염 분사 거리 상승",short="분사 거리 +50",desc="화염이 닿는 거리 +50",effect="scoreFlameRange",value=50,max=1,costs={72},wx=800,wy=3850,icon="wind",color={.94,.66,.28},requires={{"fire_score_flame_range_2",1}}},
    ...
    {id="fire_score_flame_range_4",name="화염 분사 거리 상승",short="분사 거리 +50",desc="화염이 닿는 거리 +50",effect="scoreFlameRange",value=50,max=1,costs={104},wx=1150,wy=4100,icon="wind",color={.94,.66,.28},requires={{"fire_score_flame_range_3",1}}},
    ...
    {id="fire_score_flame_range_5",name="화염 분사 거리 상승",short="분사 거리 +50",desc="화염이 닿는 거리 +50",effect="scoreFlameRange",value=50,max=1,costs={142},wx=1000,wy=4350,icon="wind",color={.94,.66,.28},requires={{"fire_score_flame_range_4",1}}},
    ...
    {id="fire_score_popper_bounce_1",name="뻥튀기 튕김 횟수 증가",short="접촉 +1",desc="한 발이 연속으로 접촉하는 나무 +1 (기본 3그루)",effect="scorePopperBounces",value=1,max=1,costs={130},wx=2600,wy=2350,icon="split",color={.96,.82,.58},requires={{"fire_score_popper_unlock",1}}},
    {id="fire_score_popper_heat_1",name="뻥튀기 가열시간 감소",short="단계당 -0.1초",desc="단계마다 점화 후 발사까지 걸리는 시간 -0.1초 (기본 2.8초)",effect="scorePopperHeat",value=.1,max=2,costs={40,50},wx=2900,wy=2350,icon="clock",color={1,.50,.18},requires={{"fire_score_popper_unlock",1}}},
...
expand("universal",{
    ...
    {id="universal_bomb_monkey",name="폭탄 운반 원숭이",short="폭탄 원숭이 해금",desc="원숭이가 검은 구형 폭탄을 몸 앞으로 들고 다니다 10초마다 내려놓습니다. 꽁초·화염방사기·불타는 나무·불붙은 기름이 도화선에 닿으면 2.6초 뒤 폭발합니다.",effect="scoreBombMonkey",value=1,max=1,costs={180},wx=4700,wy=1550,icon="blast",color={.92,.42,.16},requires={{"universal_mole_dual",1}},scoreMode=true},
    {id="universal_bomb_interval",name="폭탄 보급 단축",short="투하 주기 감소",desc="단계마다 폭탄 투하 주기가 1초 감소합니다.",effect="scoreBombInterval",value=1,max=3,costs={90,145,220},wx=5000,wy=1400,icon="clock",color={.78,.60,.28},requires={{"universal_bomb_monkey",1}},scoreMode=true},
    {id="universal_bomb_fuse",name="짧은 도화선",short="도화선 시간 감소",desc="단계마다 점화 후 폭발까지 걸리는 시간이 0.35초 감소합니다.",effect="scoreBombFuse",value=.35,max=3,costs={100,160,240},wx=5000,wy=1700,icon="ember",color={1,.48,.15},requires={{"universal_bomb_monkey",1}},scoreMode=true},
    {id="universal_bomb_radius",name="대형 폭약 충전",short="폭발 범위 상승",desc="기본 폭발 반경 180에 단계마다 35가 더해집니다.",effect="scoreBombRadius",value=35,max=4,costs={110,180,280,420},wx=5350,wy=1400,icon="split",color={.95,.55,.20},requires={{"universal_bomb_interval",1}},scoreMode=true},
    {id="universal_bomb_damage",name="고성능 흑색화약",short="폭발 피해 상승",desc="기본 폭발 피해 14에 단계마다 4가 더해집니다.",effect="scoreBombDamage",value=4,max=5,costs={120,190,290,430,620},wx=5350,wy=1700,icon="fist",color={.88,.34,.14},requires={{"universal_bomb_fuse",1}},scoreMode=true},
    {id="universal_bomb_extra",name="폭탄 운반 2인조",short="원숭이 추가",desc="폭탄 운반 원숭이가 한 마리 더 합류해 서로 떨어진 구역을 돌며 폭탄을 놓습니다.",effect="scoreBombExtra",value=1,max=1,costs={600},wx=5700,wy=1550,icon="capstone",color={1,.38,.12},requires={{"universal_bomb_radius",3},{"universal_bomb_damage",3}},scoreMode=true,capstone=true},
