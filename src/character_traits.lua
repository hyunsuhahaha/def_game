...
local scoreFireNodes={
    ...
    {id="fire_score_popper_unlock",name="원숭이 뻥튀기차 해금",short="원숭이 뻥튀기차",desc="원숭이가 맵 안에서 계속 뻥튀기차를 끕니다. 쿨타임 뒤 꽁초·화염·불붙은 기름과 접촉하면 예열 후 거대한 뻥튀기를 발사합니다.",effect="scorePopperUnlock",value=1,max=1,costs={650},wx=2500,wy=1100,icon="popping_machine",color={.88,.62,.30},requires={{"fire_score_autothrow",1}},capstone=true},
    {id="fire_score_popper_damage_1",name="뻥튀기 충돌 피해 상승",short="단계당 피해 +1",desc="단계마다 나무에 부딪힐 때 주는 피해 +1",effect="scorePopperDamage",value=1,max=3,costs={30,35,45},wx=2500,wy=1400,icon="fist",color={.90,.72,.46},requires={{"fire_score_popper_unlock",1}}},
    {id="fire_score_popper_bounce_1",name="뻥튀기 튕김 횟수 증가",short="접촉 +1",desc="한 발이 연속으로 접촉하는 나무 +1 (기본 3그루)",effect="scorePopperBounces",value=1,max=1,costs={130},wx=2850,wy=1400,icon="split",color={.96,.82,.58},requires={{"fire_score_popper_unlock",1}}},
    {id="fire_score_popper_heat_1",name="뻥튀기 가열시간 감소",short="단계당 -0.1초",desc="단계마다 점화 후 발사까지 걸리는 시간 -0.1초 (기본 2.8초)",effect="scorePopperHeat",value=.1,max=2,costs={40,50},wx=3200,wy=1400,icon="clock",color={1,.50,.18},requires={{"fire_score_popper_unlock",1}}},
    {id="fire_score_popper_damage_2",name="뻥튀기 충돌 피해 상승",short="단계당 피해 +1",desc="단계마다 나무에 부딪힐 때 주는 피해 +1",effect="scorePopperDamage",value=1,max=3,costs={50,60,70},wx=2500,wy=1700,icon="fist",color={.90,.72,.46},requires={{"fire_score_popper_damage_1",2}}},
    {id="fire_score_popper_bounce_2",name="뻥튀기 튕김 횟수 증가",short="접촉 +1",desc="한 발이 연속으로 접촉하는 나무 +1",effect="scorePopperBounces",value=1,max=1,costs={210},wx=2850,wy=1700,icon="split",color={.96,.82,.58},requires={{"fire_score_popper_bounce_1",1}}},
    {id="fire_score_popper_damage_3",name="뻥튀기 충돌 피해 상승",short="단계당 피해 +2",desc="단계마다 나무에 부딪힐 때 주는 피해 +2",effect="scorePopperDamage",value=2,max=2,costs={120,150},wx=3200,wy=1700,icon="fist",color={.90,.72,.46},requires={{"fire_score_popper_damage_2",2},{"fire_score_popper_bounce_1",1}}},
    {id="fire_score_popper_heat_2",name="뻥튀기 가열시간 감소",short="단계당 -0.25초",desc="단계마다 점화 후 발사까지 걸리는 시간 -0.25초",effect="scorePopperHeat",value=.25,max=2,costs={70,90},wx=3550,wy=1700,icon="clock",color={1,.50,.18},requires={{"fire_score_popper_heat_1",2}}},
    {id="fire_score_popper_extra",name="원숭이 뻥튀기차 추가",short="뻥튀기차 +1",desc="맵에서 계속 활동하는 원숭이 뻥튀기차가 1대 증가합니다.",effect="scorePopperExtra",value=1,max=1,costs={520},wx=3025,wy=2000,icon="capstone",color={1,.68,.24},requires={{"fire_score_popper_bounce_2",1},{"fire_score_popper_damage_3",2},{"fire_score_popper_heat_2",2}},capstone=true},
}
