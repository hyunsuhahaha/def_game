...
local scoreFireNodes={
    ...
    {id="fire_score_axe_crew",name="나무꾼 고용",short="나무꾼 고용",desc="도끼를 든 나무꾼이 합류해 스스로 나무를 찾아 법니다. 내 도끼 성능의 절반으로 일하며, 내가 다른 무기를 들고 있어도 계속 벌목합니다.",effect="scoreAxeCrew",value=1,max=1,costs={800},wx=200,wy=2100,icon="capstone",color={.94,.52,.20},requires={{"fire_score_axe_shock",3},{"fire_score_axe_chain",3}},capstone=true},
