...
expand("universal",{
    ...
    {id="universal_bomb_monkey",name="폭탄 운반 원숭이",short="폭탄 원숭이 해금",desc="원숭이가 검은 구형 폭탄을 머리에 이고 다니다 10초마다 내려놓습니다. 꽁초·화염방사기·불타는 나무·불붙은 기름이 도화선에 닿으면 2.6초 뒤 폭발합니다.",effect="scoreBombMonkey",value=1,max=1,costs={180},wx=4700,wy=1550,icon="blast",color={.92,.42,.16},requires={{"universal_mole_dual",1}},scoreMode=true},
