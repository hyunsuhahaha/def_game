local Art={image=nil,quads=nil,cat=nil,catQuad=nil,drum=nil}
...
function Art.has(icon)return order[icon]~=nil or icon=="oil_drum"or icon=="gray_cat"end
function Art.draw(icon,cx,cy,size,alpha)
    if icon=="oil_drum"or icon=="gray_cat"then
