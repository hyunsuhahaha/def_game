return {
    ...
    {id="mining_drone", name="채굴 드론", tags={"채광","자동화"}, desc="주기적으로 광석을 생산합니다.",
        cost={stone=12}, behavior="produce", resource="ore", interval=6.5, amount=2, footprint=46},
    {id="logging_bot", name="벌목 로봇", tags={"벌목","자동화"}, desc="주기적으로 목재를 생산합니다.",
        cost={wood=12}, behavior="produce", resource="wood", interval=6.2, amount=2, footprint=46},
