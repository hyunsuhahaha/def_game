...
assert(gameSource:find("updateBossEntrance",1,true) and gameSource:find("CameraDepthArt.drawFront",1,true),"combat freeze or foreground plane missing")
assert(not clearcut:find("등장!",1,true),"generic boss entrance text returned")
print("CINEMATIC_CAMERA_BOSS_INTRO_OK maps=5 planes=3 input_inverse=roll+zoom combat_freeze=yes text_banner=none")
