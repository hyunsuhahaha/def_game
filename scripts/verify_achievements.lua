...
local a=A.new(true)
assert(#a:getDefinitions()==25,"achievement catalog must contain 25 entries")
...
assert(clearcut:find("recordTree",1,true) and clearcut:find('add("vegan_eaten"',1,true) and clearcut:find('add("bosses"',1,true),"gameplay achievement hooks missing")
print("ACHIEVEMENTS_OK total=25 species=13 points=separate rewards=4 popup=queued save=v1")
