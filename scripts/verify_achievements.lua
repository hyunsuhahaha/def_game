...
assert(not migrated.maps.greatforest and not migrated.clears.greatforest and migrated.stats.maps_seen==1 and migrated.stats.unique_operations==1,"removed map survived save migration")
...
print("ACHIEVEMENTS_OK total=27 species=13 operations=5 rewards=4 popup=queued save=v1 removed_map=migrated")
