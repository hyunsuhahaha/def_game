...
local notices={}
local game={mode="playing",player={x=100,y=120},world={drops={{x=900,y=700,magnet=false}},popups={}},
...
assert(#mode.bossMagnetPickups==0 and game.world.drops[1].magnet,"magnet pickup did not attract every world drop")
...
print("BOSS_DEFEAT_REWARDS_OK heal=20 clamp=max magnet=drop+vacuum+stage_persist once=true atlas=128")
