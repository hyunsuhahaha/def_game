...
assert(lobby:find('ACTIVE_DEVELOPMENT_MODE="score_attack"',1,true)and lobby:find("첫 45초 몬스터 없음",1,true),"score mode is not clearly marked as the intentional active prototype")
assert(lobby:find("기록전 영구 연구",1,true)and lobby:find("첫 불씨 · 초기 목재 · 자동화 · 허용량",1,true),"active score research entry is missing from lobby")
