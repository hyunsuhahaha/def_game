...
assert(not lobby:find("local target=mx>=0",1,true),"lobby background still follows passive mouse movement")
assert(lobby:find("backgroundDragging",1,true)and lobby:find("function Lobby:mousemoved",1,true)and lobby:find("function Lobby:mousereleased",1,true),"lobby background drag input is missing")
assert(game:find("self.lobby:mousemoved",1,true)and game:find("self.lobby:mousereleased",1,true),"lobby background drag callbacks are not routed")
