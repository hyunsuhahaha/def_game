...
image.save(OUT/'mole-companion-team-v2-display-scale.png')
image.crop((55,145,420,355)).resize((1095,630)).save(OUT/'mole-companion-team-v2-3x.png')
CAPTURE.unlink()
print('MOLE_COMPANION_TEAM_PREVIEW_OK window=none actual=520x360 zoom=3x')
