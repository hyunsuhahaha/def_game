...
puddle = Image.open(root / "assets/fx/oil-drum-spill/oil-puddle-atlas-pixel-v1.png").convert("RGBA")
fire = Image.open(root / "assets/fx/oil-drum-spill/burning-oil-atlas-pixel-v1.png").convert("RGBA")
...
print("GRAY_OIL_CAT_ASSETS_OK cat=18 drum=1 spill=8 puddle=8 fire=8")
