...
spill = Image.open(root / "assets/fx/oil-drum-spill/oil-drum-spill-generated-v1.png").convert("RGBA")
assert atlas.size == (768, 384)
assert drum.size == (128, 128)
assert spill.size == (2172, 724)
...
for row in range(2):
    for frame in range(4):
        assert spill.crop((frame * 543, row * 362, (frame + 1) * 543, (row + 1) * 362)).getbbox()
