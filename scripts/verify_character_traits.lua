...
assert(#store:getScoreAttackNodes("fire")==22 and #store:getScoreAttackNodes("universal")==19,"active research board did not expose the split companion graphs and the weapon-slot branches")
