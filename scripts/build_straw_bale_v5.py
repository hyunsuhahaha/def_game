"""Extract and bake the straight, axis-aligned straw-bale body source."""
...
SOURCE=ROOT/"assets/fx/straw-bale/concepts/straw-bale-body-source-v5.png"
CUTOUT=ROOT/"assets/fx/straw-bale/concepts/straw-bale-body-cutout-v5.png"
DEST=ROOT/"assets/fx/straw-bale/straw-bale-body-pixel-v5.png"
...
def main():
    ...
    cv2.grabCut(bgr,mask,(70,120,w-140,h-245),bg,fg,9,cv2.GC_INIT_WITH_RECT)
    ...
    canvas.save(DEST)
    print(f"STRAW_BALE_BODY_V5_OK source={w}x{h} sprite={canvas.size} body={rgb.size} colors=144")
