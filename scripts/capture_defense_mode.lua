...
local world=World.new();world:useArcadeForest();world.width,world.height=2240,1400;world.theme="forest"
...
love.graphics.push();love.graphics.translate(136,45);love.graphics.scale(.45,.45)
world:draw(player,mode)
love.graphics.pop()
local font=love.graphics.newFont("assets/font-korean-regular.ttf",18);love.graphics.setFont(font)
love.graphics.setColor(1,.94,.72,1);love.graphics.print("무한 디펜스 · 1–4단계 원형 숲",24,20)
fixture.save("docs/previews/defense-mode-v1-draws.json")
print("DEFENSE_MODE_CAPTURE_OK stages=4 trees=96 window=none")
