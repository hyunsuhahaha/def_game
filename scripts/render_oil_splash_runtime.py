...
image.save(OUT/"oil-splash-runtime-v3-actual.png")
image.crop((385,90,720,330)).resize((1340,960),Image.Resampling.NEAREST).save(OUT/"oil-splash-runtime-v3-4x.png")
print("OIL_SPLASH_RUNTIME_RENDER_OK actual=1200x420 enlarged=1340x960 window=none")
