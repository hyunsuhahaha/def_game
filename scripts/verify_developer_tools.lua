...
local game=setmetatable({
    ...
    characterTraits={reset=function()resets.traits=resets.traits+1 end},
...
assert(game.progression.data.currency==1000000,"developer currency grant failed")
...
print("DEVELOPER_TOOLS_OK currency=1m resources=next_once levels=current10+next20 modes=standard+rush+clearcut reset=confirmed")
