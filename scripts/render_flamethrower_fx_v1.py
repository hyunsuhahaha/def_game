...
frames = [render_ui(OUT / f"flamethrower-fx-v4-draws-{i}.json", (1280, 720)) for i in range(8)]
frames[0].save(
    OUT / "flamethrower-fx-v4-runtime.gif", save_all=True,
...
draw.text((22, 18), "화염방사기 v4 · 대형 난류 화염 · 실제 게임 배율", font=font, fill=(255, 220, 92))
sheet.save(OUT / "flamethrower-fx-v4-runtime-sheet.png")
print("FLAMETHROWER_FX_V4_RENDER_OK frames=8 renderer=Pillow-command-replay window=none")
