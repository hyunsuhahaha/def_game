...
axe = Image.open(ROOT / "assets/characters/ingame/smoker-score-axe-atlas-pixel-v1.png").convert("RGBA")
assert drum.size == (384, 128)
assert hit.size == (1152, 160)
assert axe.size == (576, 192)
...
axe_frames = [axe.crop((i * 96, 0, (i + 1) * 96, 192)) for i in range(6)]
...
print("SCORE_AXE_DRUM_ASSETS_OK axe=576x192/6 full-body poses drum=384x128/3 hit=1152x160/6")
