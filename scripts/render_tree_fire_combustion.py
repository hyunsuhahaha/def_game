...
capture=OUT/'tree-fire-loop-v3-runtime.json'
...
capture.unlink()
runtime.save(OUT/'tree-fire-loop-v3-display-scale.png')
crop=(270,150,490,425)
zoom=runtime.crop(crop).resize((660,825),Image.Resampling.NEAREST)
zoom.save(OUT/'tree-fire-loop-v3-3x.png')
...
for index in range(20):
    ...
    frames.append(frame)
frames[0].save(OUT/'tree-fire-loop-v3-runtime.gif',save_all=True,append_images=frames[1:],duration=68,loop=0,disposal=2)
print('TREE_FIRE_LOOP_V3_PREVIEW_OK window=none actual=760x430 frames=20 gif=runtime')
