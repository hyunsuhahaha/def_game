...
디펜스는 원형 나무 띠 하나가 한 단계다. 넓어진 전용 맵의 화면 밖 외곽에서 단계당 96그루가 수관을 맞물리며 접근하고, 기존 띠 제거 여부와 관계없이 2.5초마다 체력이 더 높은 다음 단계 띠가 계속 유입된다. 나무가 중앙 방어선에 닿으면 패배하며 승리나 시간 제한은 없다.
